...
I wrote and tested the HTML5 and CSS3 entirely in Notepad++ and Google Chrome. The underlying data was compiled locally in Excel, tested in R-Studio, and converted to a Google Charts friendly format via Python scripts run through online interpreters. 
